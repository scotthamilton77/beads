...
- **Gemini CLI** (`bd setup gemini`): Adds hooks to Gemini's settings.json that run `bd prime --gemini-hook` on the SessionStart event and manages a minimal-profile beads section in `GEMINI.md`
